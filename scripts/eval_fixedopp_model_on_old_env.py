# scripts/eval_fixedopp_model_on_old_env.py
import argparse
import csv
import json
import os
...
def main():
    ...
    parser.add_argument(
        "--run_dir",
        type=str,
        default="checkpoints/outputs/qrdqn_rowdeepsets_fixedopp_seed2",
    )
    ...
    summary = {
        ...
        "test_env": "old_random_opponent_env",
    ...
    json_out = os.path.join(args.run_dir, "cross_eval_fixedopp_model_on_old_env.json")
    with open(json_out, "w", encoding="utf-8") as f:
        json.dump(summary, f, indent=2, ensure_ascii=False)

    csv_out = os.path.join(args.run_dir, "cross_eval_fixedopp_model_on_old_env_episode_returns.csv")
